...
var Juego = {
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 400, 300, 10, 10, 1, {
      desdeX: 0, 
      hastaX: 870, 
      desdeY: 0, 
      hastaY: 961
    }),
    new ZombieCaminante('imagenes/zombie2.png', 500, 200, 10, 10, 1, {
      desdeX: 0, 
      hastaX: 870, 
      desdeY: 0, 
      hastaY: 961
    }),
    new ZombieCaminante('imagenes/zombie3.png', 600, 100, 10, 10, 1, {
      desdeX: 0, 
      hastaX: 870, 
      desdeY: 0, 
      hastaY: 961
    }),
    new ZombieCaminante('imagenes/zombie4.png', 700, 200, 10, 10, 1, {
      desdeX: 0, 
      hastaX: 870, 
      desdeY: 0, 
      hastaY: 961
    }),
    new ZombieCaminante('imagenes/punk_zombie.png', 800, 300, 15, 15, 1, {
      desdeX: 0, 
      hastaX: 870, 
      desdeY: 0, 
      hastaY: 961
    ...
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 5, {
      ...
      desdeY: 0, 
      hastaY: 961}, 'h'), 
    new ZombieConductor('imagenes/tren_vertical.png', 644, 100, 30, 90, 5, {
      desdeX: 644, 
      hastaX: 644,
      desdeY: 20,
      hastaY: 480}, 'v'),
    new ZombieConductor('imagenes/tren_vertical.png', 674, 300, 30, 90, 5, {
      desdeX: 674,
      hastaX: 674,
      desdeY: 20,
      hastaY: 480}, 'v')
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
    ...
    Jugador.movimientos(movX,movY,tecla);
  }
};
...
Juego.dibujar = function() {
  ...
  Dibujante.dibujarEntidad(Salida);
  Dibujante.dibujarEntidad(Salida2);
...
Juego.dibujarFondo = function() {
  ...
  if (this.terminoJuego()) {
    Dibujante.dibujarImagen('imagenes/Game_Over_.jpg', 0, 5, this.anchoCanvas, this.altoCanvas);
    document.getElementById('reiniciar').style.visibility = 'visible';
    Dibujante.borrarAreaDeJuego(Enemigos);
  }
